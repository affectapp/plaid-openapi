...
pub async fn asset_report_relay_create(configuration: &configuration::Configuration, asset_report_relay_create_request: crate::models::AssetReportRelayCreateRequest) -> Result<crate::models::AssetReportRelayCreateResponse, Error<AssetReportRelayCreateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/asset_report/relay/create", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AssetReportRelayCreateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn asset_report_relay_get(configuration: &configuration::Configuration, asset_report_relay_get_request: crate::models::AssetReportRelayGetRequest) -> Result<crate::models::AssetReportGetResponse, Error<AssetReportRelayGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/asset_report/relay/get", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AssetReportRelayGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn asset_report_relay_refresh(configuration: &configuration::Configuration, asset_report_relay_refresh_request: crate::models::AssetReportRelayRefreshRequest) -> Result<crate::models::AssetReportRelayRefreshResponse, Error<AssetReportRelayRefreshError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/asset_report/relay/refresh", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AssetReportRelayRefreshError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn asset_report_relay_remove(configuration: &configuration::Configuration, asset_report_relay_remove_request: crate::models::AssetReportRelayRemoveRequest) -> Result<crate::models::AssetReportRelayRemoveResponse, Error<AssetReportRelayRemoveError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/asset_report/relay/remove", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AssetReportRelayRemoveError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn transactions_rules_create(configuration: &configuration::Configuration, transactions_rules_create_request: crate::models::TransactionsRulesCreateRequest) -> Result<crate::models::TransactionsRulesCreateResponse, Error<TransactionsRulesCreateError>> {
    ...
    let local_var_uri_str = format!("{}/beta/transactions/rules/create", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn transactions_rules_list(configuration: &configuration::Configuration, transactions_rules_list_request: crate::models::TransactionsRulesListRequest) -> Result<crate::models::TransactionsRulesListResponse, Error<TransactionsRulesListError>> {
    ...
    let local_var_uri_str = format!("{}/beta/transactions/rules/list", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn transactions_rules_remove(configuration: &configuration::Configuration, transactions_rules_remove_request: crate::models::TransactionsRulesRemoveRequest) -> Result<crate::models::TransactionsRulesRemoveResponse, Error<TransactionsRulesRemoveError>> {
    ...
    let local_var_uri_str = format!("{}/beta/transactions/rules/remove", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());

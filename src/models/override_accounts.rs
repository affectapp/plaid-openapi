...
pub struct OverrideAccounts {
    ...
    #[serde(
        rename = "investment_transactions",
...
impl OverrideAccounts {
    ...
    pub fn new(
        _type: crate::models::OverrideAccountType,
        subtype: Option<crate::models::AccountSubtype>,
        starting_balance: f64,
        force_available_balance: f64,
        currency: String,
        meta: crate::models::Meta,
        numbers: crate::models::Numbers,
        transactions: Vec<crate::models::TransactionOverride>,
        identity: crate::models::OwnerOverride,
        liability: crate::models::LiabilityOverride,
        inflow_model: crate::models::InflowModel,
    ) -> OverrideAccounts {
        OverrideAccounts {
            _type,
            subtype,

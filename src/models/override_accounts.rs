...
pub struct OverrideAccounts {
    #[serde(rename = "type")]
    pub _type: crate::models::OverrideAccountType,
    ...
    pub transactions: Vec<crate::models::TransactionOverride>,
    #[serde(rename = "holdings", skip_serializing_if = "Option::is_none")]
    pub holdings: Option<Box<crate::models::HoldingsOverride>>,
    #[serde(rename = "investment_transactions", skip_serializing_if = "Option::is_none")]
    pub investment_transactions: Option<Box<crate::models::InvestmentsTransactionsOverride>>,
    #[serde(rename = "identity")]
    pub identity: crate::models::OwnerOverride,
    #[serde(rename = "liability")]
    pub liability: crate::models::LiabilityOverride,
    #[serde(rename = "inflow_model")]
    pub inflow_model: crate::models::InflowModel,
    #[serde(rename = "income", skip_serializing_if = "Option::is_none")]
    pub income: Option<Box<crate::models::IncomeOverride>>,
}

impl OverrideAccounts {
    /// Data to use to set values of test accounts. Some values cannot be specified in the schema and will instead will be calculated from other test data in order to achieve more consistent, realistic test data.
    pub fn new(_type: crate::models::OverrideAccountType, subtype: Option<crate::models::AccountSubtype>, starting_balance: f64, force_available_balance: f64, currency: String, meta: crate::models::Meta, numbers: crate::models::Numbers, transactions: Vec<crate::models::TransactionOverride>, identity: crate::models::OwnerOverride, liability: crate::models::LiabilityOverride, inflow_model: crate::models::InflowModel) -> OverrideAccounts {
        OverrideAccounts {
            _type,
            subtype,
            starting_balance,

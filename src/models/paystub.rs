...
impl Paystub {
    ...
    pub fn new(
        deductions: crate::models::Deductions,
        doc_id: String,
        earnings: crate::models::Earnings,
        employee: crate::models::Employee,
        employer: crate::models::PaystubEmployer,
        net_pay: crate::models::NetPay,
        pay_period_details: crate::models::PayPeriodDetails,
        verification: Option<crate::models::PaystubVerification>,
    ) -> Paystub {
        Paystub {
            deductions,
            doc_id,

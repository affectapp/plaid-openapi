...
impl PaymentStatusUpdateWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, payment_id: String, new_payment_status: crate::models::PaymentInitiationPaymentStatus, old_payment_status: crate::models::PaymentInitiationPaymentStatus, original_reference: Option<String>, original_start_date: Option<String>, adjusted_start_date: Option<String>, timestamp: String) -> PaymentStatusUpdateWebhook {

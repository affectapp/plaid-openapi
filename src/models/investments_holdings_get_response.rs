...
impl InvestmentsHoldingsGetResponse {
    ...
    pub fn new(accounts: Vec<crate::models::AccountBase>, holdings: Vec<crate::models::Holding>, securities: Vec<crate::models::Security>, item: crate::models::Item, request_id: String) -> InvestmentsHoldingsGetResponse {

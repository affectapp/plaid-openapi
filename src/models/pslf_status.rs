...
pub struct PslfStatus {
    ...
    pub payments_made: Option<f32>,
    /// The number of qualifying payments remaining.
    #[serde(rename = "payments_remaining")]
    pub payments_remaining: Option<f32>,
}

impl PslfStatus {
    /// Information about the student's eligibility in the Public Service Loan Forgiveness program. This is only returned if the institution is Fedloan (`ins_116527`). 
    pub fn new(estimated_eligibility_date: Option<String>, payments_made: Option<f32>, payments_remaining: Option<f32>) -> PslfStatus {
        PslfStatus {

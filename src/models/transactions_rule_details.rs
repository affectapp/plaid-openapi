...
pub struct TransactionsRuleDetails {
    ...
    #[serde(rename = "type")]
    pub _type: crate::models::TransactionsRuleType,
...
impl TransactionsRuleDetails {
    ...
    pub fn new(field: crate::models::TransactionsRuleField, _type: crate::models::TransactionsRuleType, query: String) -> TransactionsRuleDetails {

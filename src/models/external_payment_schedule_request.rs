...
pub struct ExternalPaymentScheduleRequest {
    #[serde(rename = "interval")]
    pub interval: crate::models::PaymentScheduleInterval,
    ...
    #[serde(rename = "adjusted_start_date", skip_serializing_if = "Option::is_none")]
    pub adjusted_start_date: Option<String>,
}

impl ExternalPaymentScheduleRequest {
    /// The schedule that the payment will be executed on. If a schedule is provided, the payment is automatically set up as a standing order. If no schedule is specified, the payment will be executed only once.
    pub fn new(interval: crate::models::PaymentScheduleInterval, interval_execution_day: i32, start_date: String) -> ExternalPaymentScheduleRequest {

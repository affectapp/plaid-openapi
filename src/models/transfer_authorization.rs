...
pub struct TransferAuthorization {
    ...
    pub guarantee_decision_rationale:
        Option<crate::models::TransferAuthorizationGuaranteeDecisionRationale>,
...
impl TransferAuthorization {
    ...
    pub fn new(
        id: String,
        created: String,
        decision: crate::models::TransferAuthorizationDecision,
        decision_rationale: Option<crate::models::TransferAuthorizationDecisionRationale>,
        guarantee_decision: Option<crate::models::TransferAuthorizationGuaranteeDecision>,
        guarantee_decision_rationale: Option<
            crate::models::TransferAuthorizationGuaranteeDecisionRationale,
        >,
        proposed_transfer: crate::models::TransferAuthorizationProposedTransfer,

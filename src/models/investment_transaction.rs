...
pub struct InvestmentTransaction {
    ...
    pub fees: Option<f64>,
    #[serde(rename = "type")]
    pub _type: crate::models::InvestmentTransactionType,
...
impl InvestmentTransaction {
    ...
    pub fn new(investment_transaction_id: String, account_id: String, security_id: Option<String>, date: String, name: String, quantity: f64, amount: f64, price: f64, fees: Option<f64>, _type: crate::models::InvestmentTransactionType, subtype: crate::models::InvestmentTransactionSubtype, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> InvestmentTransaction {

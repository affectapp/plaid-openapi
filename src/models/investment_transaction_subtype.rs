...
impl ToString for InvestmentTransactionSubtype {
    fn to_string(&self) -> String {
        match self {
            ...
            Self::LongTermCapitalGainReinvestment => {
                String::from("long-term capital gain reinvestment")
            }
            ...
            Self::ShortTermCapitalGainReinvestment => {
                String::from("short-term capital gain reinvestment")
            }

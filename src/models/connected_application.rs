...
pub struct ConnectedApplication {
    ...
    #[serde(rename = "status")]
    pub status: crate::models::ConnectedApplicationStatus,
}

impl ConnectedApplication {
    /// Describes the connected application for a particular end user.
    pub fn new(application_id: String, name: String, logo: Option<String>, logo_url: Option<String>, application_url: Option<String>, reason_for_access: Option<String>, created_at: String, join_date: String, product_data_types: ProductDataTypes, status: crate::models::ConnectedApplicationStatus) -> ConnectedApplication {

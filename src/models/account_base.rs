...
impl AccountBase {
    ...
    pub fn new(account_id: String, balances: crate::models::AccountBalance, mask: Option<String>, name: String, official_name: Option<String>, _type: crate::models::AccountType, subtype: Option<crate::models::AccountSubtype>) -> AccountBase {
        AccountBase {
            account_id,
            balances,
            mask,

...
impl PaymentInitiationPaymentGetResponse {
    ...
    pub fn new(payment_id: String, amount: crate::models::PaymentAmount, status: crate::models::PaymentInitiationPaymentStatus, recipient_id: String, reference: String, last_status_update: String, bacs: Option<crate::models::SenderBacsNullable>, iban: Option<String>, request_id: String) -> PaymentInitiationPaymentGetResponse {

...
impl AccountAssets {
    ...
    pub fn new(
        account_id: String,
        balances: crate::models::AccountBalance,
        mask: Option<String>,
        name: String,
        official_name: Option<String>,
        _type: crate::models::AccountType,
        subtype: Option<crate::models::AccountSubtype>,
        days_available: f32,
        transactions: Vec<crate::models::AssetReportTransaction>,
        owners: Vec<crate::models::Owner>,
        historical_balances: Vec<crate::models::HistoricalBalance>,
    ) -> AccountAssets {
        AccountAssets {
            account_id,
            balances,

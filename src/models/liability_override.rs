...
impl LiabilityOverride {
    ...
    pub fn new(
        ...
        principal: f64,
        nominal_apr: f64,
        interest_capitalization_grace_period_months: f32,
        repayment_model: crate::models::StudentLoanRepaymentModel,
        expected_payoff_date: String,
        guarantor: String,
        is_federal: bool,
        loan_name: String,
        loan_status: crate::models::StudentLoanStatus,
        payment_reference_number: String,
        pslf_status: crate::models::PslfStatus,
        repayment_plan_description: String,
        repayment_plan_type: String,
        sequence_number: String,
        servicer_address: crate::models::Address,
    ) -> LiabilityOverride {
        LiabilityOverride {
            _type,
            purchase_apr,

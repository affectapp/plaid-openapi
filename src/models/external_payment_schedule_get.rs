...
impl ExternalPaymentScheduleGet {
    ...
    pub fn new(interval: crate::models::PaymentScheduleInterval, interval_execution_day: i32, start_date: String, end_date: Option<String>, adjusted_start_date: Option<String>) -> ExternalPaymentScheduleGet {

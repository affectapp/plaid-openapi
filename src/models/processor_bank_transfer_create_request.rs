...
impl ProcessorBankTransferCreateRequest {
    ...
    pub fn new(idempotency_key: String, processor_token: String, _type: crate::models::BankTransferType, network: crate::models::BankTransferNetwork, amount: String, iso_currency_code: String, description: String, user: crate::models::BankTransferUser) -> ProcessorBankTransferCreateRequest {

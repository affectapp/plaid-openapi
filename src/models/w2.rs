...
pub struct W2 {
    ...
    #[serde(rename = "tax_year", skip_serializing_if = "Option::is_none")]
    pub tax_year: Option<String>,
    /// An employee identification number or EIN.
    #[serde(rename = "employer_id_number", skip_serializing_if = "Option::is_none")]
    pub employer_id_number: Option<String>,
    /// Wages from tips and other compensation.
    #[serde(rename = "wages_tips_other_comp", skip_serializing_if = "Option::is_none")]
    pub wages_tips_other_comp: Option<String>,
    /// Federal income tax withheld for the tax year.
    #[serde(rename = "federal_income_tax_withheld", skip_serializing_if = "Option::is_none")]
    pub federal_income_tax_withheld: Option<String>,
    /// Wages from social security.
    #[serde(rename = "social_security_wages", skip_serializing_if = "Option::is_none")]
    pub social_security_wages: Option<String>,
    /// Social security tax withheld for the tax year.
    #[serde(rename = "social_security_tax_withheld", skip_serializing_if = "Option::is_none")]
    pub social_security_tax_withheld: Option<String>,
    /// Wages and tips from medicare.
    #[serde(rename = "medicare_wages_and_tips", skip_serializing_if = "Option::is_none")]
    pub medicare_wages_and_tips: Option<String>,
    /// Medicare tax withheld for the tax year.
    #[serde(rename = "medicare_tax_withheld", skip_serializing_if = "Option::is_none")]
    pub medicare_tax_withheld: Option<String>,
    /// Tips from social security.
    #[serde(rename = "social_security_tips", skip_serializing_if = "Option::is_none")]
    pub social_security_tips: Option<String>,
    /// Allocated tips.
    #[serde(rename = "allocated_tips", skip_serializing_if = "Option::is_none")]
    pub allocated_tips: Option<String>,
    /// Contents from box 9 on the W2.
    #[serde(rename = "box_9", skip_serializing_if = "Option::is_none")]
    pub box_9: Option<String>,
    /// Dependent care benefits.
    #[serde(rename = "dependent_care_benefits", skip_serializing_if = "Option::is_none")]
    pub dependent_care_benefits: Option<String>,
    /// Nonqualified plans.
    #[serde(rename = "nonqualified_plans", skip_serializing_if = "Option::is_none")]
    ...
    /// Statutory employee.
    #[serde(rename = "statutory_employee", skip_serializing_if = "Option::is_none")]
    pub statutory_employee: Option<String>,
    /// Retirement plan.
    #[serde(rename = "retirement_plan", skip_serializing_if = "Option::is_none")]
    pub retirement_plan: Option<String>,
    /// Third party sick pay.
    #[serde(rename = "third_party_sick_pay", skip_serializing_if = "Option::is_none")]

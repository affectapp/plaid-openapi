...
pub struct PaymentConsentPeriodicAmount {
    ...
    pub alignment: Option<crate::models::PaymentConsentPeriodicAlignment>,
}

impl PaymentConsentPeriodicAmount {
    /// Defines consent payments limitations per period.
    pub fn new(amount: crate::models::PaymentConsentPeriodicAmountAmount, interval: crate::models::PaymentConsentPeriodicInterval) -> PaymentConsentPeriodicAmount {

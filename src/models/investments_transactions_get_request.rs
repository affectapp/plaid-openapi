...
pub struct InvestmentsTransactionsGetRequest {
    ...
    pub options: Option<Box<crate::models::InvestmentsTransactionsGetRequestOptions>>,
}
...
impl InvestmentsTransactionsGetRequest {
    ...
    pub fn new(access_token: String, start_date: String, end_date: String) -> InvestmentsTransactionsGetRequest {

...
pub struct BankTransferCreateRequest {
    ...
    #[serde(rename = "custom_tag", skip_serializing_if = "Option::is_none")]
...
impl BankTransferCreateRequest {
    ...
    pub fn new(idempotency_key: String, access_token: String, account_id: String, _type: crate::models::BankTransferType, network: crate::models::BankTransferNetwork, amount: String, iso_currency_code: String, description: String, user: crate::models::BankTransferUser) -> BankTransferCreateRequest {

...
pub struct LinkTokenCreateRequestAccountSubtypes {
    ...
    pub depository: Option<crate::models::LinkTokenCreateDepositoryFilter>,
    #[serde(rename = "credit", skip_serializing_if = "Option::is_none")]
    pub credit: Option<crate::models::LinkTokenCreateCreditFilter>,
    #[serde(rename = "loan", skip_serializing_if = "Option::is_none")]
    pub loan: Option<crate::models::LinkTokenCreateLoanFilter>,
    #[serde(rename = "investment", skip_serializing_if = "Option::is_none")]
    pub investment: Option<crate::models::LinkTokenCreateInvestmentFilter>,
}

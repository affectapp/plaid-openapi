...
pub struct PaystubDetails {
    ...
    #[serde(rename = "pay_period_start_date", skip_serializing_if = "Option::is_none")]
    pub pay_period_start_date: Option<String>,
    /// Ending date of the pay period on the paystub in the 'YYYY-MM-DD' format.
    #[serde(rename = "pay_period_end_date", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "paystub_provider", skip_serializing_if = "Option::is_none")]
    pub paystub_provider: Option<String>,
    #[serde(rename = "pay_frequency", skip_serializing_if = "Option::is_none")]
    pub pay_frequency: Option<crate::models::PaystubPayFrequency>,
}

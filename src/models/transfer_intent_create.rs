...
impl TransferIntentCreate {
    ...
    pub fn new(id: String, created: String, status: crate::models::TransferIntentStatus, origination_account_id: String, amount: String, mode: crate::models::TransferIntentCreateMode, ach_class: crate::models::AchClass, user: crate::models::TransferUserInResponse, description: String, iso_currency_code: String) -> TransferIntentCreate {

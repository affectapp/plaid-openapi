...
pub struct WalletGetResponse {
    ...
    pub balance: Option<crate::models::WalletBalance>,
...
impl WalletGetResponse {
    ...
    pub fn new(wallet_id: String, balance: Option<crate::models::WalletBalance>, request_id: String) -> WalletGetResponse {
        WalletGetResponse {
            wallet_id,
            balance,
            request_id,

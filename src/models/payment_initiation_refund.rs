...
impl PaymentInitiationRefund {
    ...
    pub fn new(refund_id: String, amount: crate::models::PaymentAmount, status: crate::models::PaymentInitiationRefundStatus, last_status_update: String) -> PaymentInitiationRefund {

...
impl IncomeSummary {
    ...
    pub fn new(
        employer_name: crate::models::EmployerIncomeSummaryFieldString,
        employee_name: crate::models::EmployeeIncomeSummaryFieldString,
        ytd_gross_income: crate::models::YtdGrossIncomeSummaryFieldNumber,
        ytd_net_income: crate::models::YtdNetIncomeSummaryFieldNumber,
        pay_frequency: Option<crate::models::PayFrequency>,
        projected_wage: crate::models::ProjectedIncomeSummaryFieldNumber,
        verified_transaction: Option<crate::models::TransactionData>,
    ) -> IncomeSummary {
        IncomeSummary {

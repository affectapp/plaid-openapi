...
pub struct TransactionsGetRequestOptions {
    ...
    /// Please use [`include_personal_finance_category`](https://plaid.com/docs/api/products/#transactions-get-request-options-include-personal-finance-category) instead.
    #[serde(
        rename = "include_personal_finance_category_beta",
        skip_serializing_if = "Option::is_none"
    )]
    pub include_personal_finance_category_beta: Option<bool>,
    /// Include the [`personal_finance_category`](https://plaid.com/docs/api/products/#transactions-get-response-transactions-personal-finance-category) object in the response.  See the [`taxonomy csv file`](https://plaid.com/documents/transactions-personal-finance-category-taxonomy.csv) for a full list of personal finance categories.
    #[serde(
